...
def parse_args():
    parser = argparse.ArgumentParser(description="Utility functions for classification tasks.")
    parser.add_argument('--traditional_model', type=str, default=None, help='Type of traditional classifier to use, if any')
    parser.add_argument('--deep_model', type=str, default=None, help='Type of deep learning model to use, if any')
    parser.add_argument('--dataset_path', type=str, default='Datasets/N_20_Takes_2.csv', help='Path to the dataset CSV file')
...
def plot_conf_mat(
    ...
    plt.savefig(f"results/{full_filename}.png", bbox_inches="tight", dpi=300)
    plt.close(fig) 
